...
The previous 50-buyer CSV was entirely fake — all emails were @example domains and all phones were 555-XXXX. The 19-row CSV (sales_20260509T195155Z.md) and the 25-buyer list also need rebuilding from scratch.
